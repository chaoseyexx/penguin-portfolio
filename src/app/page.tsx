                            ...
                            <ScrollAnimation animation="fade-in-left" duration="duration-1000">
                                <div className="space-y-6 md:space-y-8">
                                    ...
                                    <div className="flex flex-wrap gap-4 pt-4">
                                        ...
                                        <a href="/Dante_Olmeo_CV_Updated.png" download="Dante_Olmeo_CV_Updated.png">
                                            <Button
                                                size="lg"
                                                variant="outline"
                            ...
                            <div className="flex flex-col gap-8 max-w-4xl mx-auto">
                                {settings.collaborations.map((collab, index) => (
                                    <ScrollAnimation key={collab.id} animation="fade-in-up" duration="duration-700" delay={`delay-${Math.min(index * 100, 300)}` as any}>
                                        <div className="group relative rounded-xl overflow-hidden shadow-2xl hover:shadow-primary/20 transition-all duration-300">
                                            {/* eslint-disable-next-line @next/next/no-img-element */}
                                            <img
                                                src={collab.image}
                                                alt={collab.name}
                                                className="w-full h-auto object-cover"
                                                onError={(e) => { (e.target as HTMLImageElement).src = "https://placehold.co/800x200?text=Collaboration+Image" }}
                                            />
                                        </div>
                                    </ScrollAnimation>
                                ))}
